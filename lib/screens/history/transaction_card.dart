...
class TransactionCard extends StatelessWidget {
          ...
          children: [
            Row(
              ...
              children: <Widget>[
                ...
                builInfo(context, transaction.productName, transaction.amount,
                    transaction.isAdditive),
              ],
            ),
            SizedBox(height: 20),
            Divider(
  ...
  Column builInfo(
      BuildContext context, String name, int amount, bool isAdditive) {
    return Column(
        ...
        Container(
          ...
          child: Row(
            children: [
              isAdditive
                  ? SvgPicture.asset(
                      'assets/icons/additive.svg',
                      color: Theme.of(context).primaryColor,
                    )
                  : SvgPicture.asset(
                      'assets/icons/consume.svg',
                    ),
              SizedBox(width: 8),
              Text(
                '$amount units',
